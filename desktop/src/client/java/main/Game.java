...
public class Game {
    ...
    public static void updatePlayers(List<Player> plyrs, String action){
        ...
        for (Player observablePlayer : observablePlayers) {
            if (!plyrs.contains(observablePlayer)) {
                removePlayer(observablePlayer);
            }
        }
    }
    ...
    private static void updateLocationData(Location location){
        if(locations.contains(location)){
            ...
            locations.get(index).setType(location.getType());
        }
    }
